    ...
    <div class="container-fluid px-3">
        <div class="d-flex align-items-center gap-3 py-2">
            ...
            <nav class="nav main-nav flex-nowrap flex-grow-1">
                ...
                <a class="nav-link <?php echo $page === 'partidos' ? 'active' : ''; ?>" href="index.php?page=partidos">Calendario</a>
                ...
                <a class="nav-link <?php echo $page === 'tabla' ? 'active' : ''; ?>" href="index.php?page=tabla">Estadísticas</a>
