        ...
        function cargarEquipos() {
            $.ajax({
                ...
                success: function(data) {
                            ...
                            <tr>
                                <td>
                                    <div class="d-flex align-items-center">
                                        ...
                                        <strong>${equipo.nomEqui}</strong>
                                    </div>
                                </td>
                                <td>
                                    <i class="fas fa-map-pin text-secondary me-1"></i>
                                    ${equipo.ciuEqui || 'No especificada'}
                                </td>
                                <td class="text-end">
                                    <button class="btn btn-icon btn-outline-primary me-2" onclick="editarEquipo(${equipo.codEqui})" title="Editar">
                                        <i class="fas fa-edit"></i>
                                    </button>
                                    <button class="btn btn-icon btn-outline-danger" onclick="eliminarEquipo(${equipo.codEqui})" title="Eliminar">
                    ...
                    let tabla = document.querySelector('#equiposTable tbody');
