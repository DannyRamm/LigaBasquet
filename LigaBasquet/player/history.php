...
if ($usuarioEquipo) {
    $sql = 'SELECT p.codMat, p.fecMat, p.estMat, el.nomEqui AS local, ev.nomEqui AS visitante, p.punlocMat, p.punvisMat
            FROM Partido p
            ...
            ORDER BY p.fecMat DESC LIMIT 20';
...
<head>
    <meta charset="UTF-8">
    <title>Historial Jugador | LeagueDan</title>
...
<body data-theme="light">
    ...
    <main class="container-fluid px-3 py-4">
        <h1 class="h3 mb-3">Historial de Partidos</h1>
        <?php if ($usuarioEquipo) : ?>
            <p class="text-secondary">Últimos encuentros de <?php echo htmlspecialchars($usuarioEquipo['nomEqui']); ?>.</p>
            <div class="card">
                <div class="card-body">
