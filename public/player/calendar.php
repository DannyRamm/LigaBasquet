...
<head>
    <meta charset="UTF-8">
    <title>Calendario Jugador | LeagueDan</title>
...
<body data-theme="light">
    ...
    <main class="container-fluid px-3 py-4">
        <h1 class="h3 mb-3">Calendario de Jugador</h1>

        <?php if ($usuarioEquipo) : ?>
            <p class="text-secondary">Partidos del equipo <?php echo htmlspecialchars($usuarioEquipo['nomEqui']); ?>.</p>
            <div class="card">
                <div class="card-body">
