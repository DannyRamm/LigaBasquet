            ...
            <?php foreach ($partidos as $partido) : ?>
                <?php
                    ...
                    if (!empty($partido['fecMat'])) {
                        try {
                            $fechaValue = trim((string) ($partido['fecMat'] ?? ''));
                            if ($fechaValue !== '') {
                    ...
                    $hoy = new DateTime();
                    $esHoy = $fecha ? $fecha->format('Y-m-d') === $hoy->format('Y-m-d') : false;
                ?>
                <div class="col-lg-6">
                        ...
                        <div class="card-header bg-dark text-white d-flex justify-content-between align-items-center" style="padding: 1.5rem;">
                            <div>
                                <span class="badge <?php echo $badgeClass; ?> me-2">
                                    ...
                                    <?php echo htmlspecialchars(ucfirst((string) ($partido['estMat'] ?? ''))); ?>
                                </span>
                                <?php if ($esHoy) : ?>
                            ...
                            <small class="text-light">
                                ...
                                <?php echo $fecha ? $fecha->format('d/m/Y') : 'Fecha pendiente'; ?>
                            </small>
                        </div>
                            ...
                            <div class="row align-items-center mb-4">
                                ...
                                <div class="col-md-4 text-center">
                                    ...
                                    <?php else : ?>
                                        ...
                                        <small class="text-muted"><?php echo $fecha ? $fecha->format('H:i') : 'TBD'; ?></small>
                                    <?php endif; ?>
                                </div>
