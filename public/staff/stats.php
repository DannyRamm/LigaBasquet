...
if ($equipo) {
    $sql = 'SELECT p.codMat, p.fecMat, p.estMat, p.punlocMat, p.punvisMat, el.nomEqui AS local, ev.nomEqui AS visitante
            ...
            ORDER BY p.fecMat DESC LIMIT 10';
...
<head>
    <meta charset="UTF-8">
    <title>Estadísticas Staff | LeagueDan</title>
...
<body data-theme="light">
    ...
    <main class="container-fluid px-3 py-4">
        <h1 class="h3 mb-3">Estadísticas del equipo</h1>
        <?php if ($equipo) : ?>
            <p class="text-secondary">Últimos partidos de <?php echo htmlspecialchars($equipo['nomEqui']); ?>.</p>
            <div class="card">
                <div class="card-body">
